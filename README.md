...
- Writing foundational SQL scripts

- Organizing datasets and documentation

- Iterative commits to track progress

### 3. Version Control & Collaboration

- Tracking all changes to the warehouse
...
1. SQL Server (local or cloud-hosted)
